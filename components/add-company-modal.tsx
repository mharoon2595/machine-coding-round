...
export function AddCompanyModal({ ownerId }: { ownerId: number }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setIsOpen(false);
      setFormData({ name: "", representation: "", slug: "", status: "Active" });
      router.refresh();
    } catch (err: any) {
  ...
  return (
    <>
      <Button
        ...
        className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white shadow-lg transition-all duration-300 transform hover:scale-105"
      >
          ...
          <div className="bg-card w-full max-w-md border rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
            <div className="relative p-6 border-b bg-muted/50">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Enter the details of your new business entity.
              </p>
            </div>
