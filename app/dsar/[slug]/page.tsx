...
async function CompanyPortalContent({ params }: Props) {
...
export default function PublicCompanyPage({ params }: Props) {
  return (
    <div className="min-h-screen bg-slate-50/50 dark:bg-slate-950 pb-20">
      ...
      <Suspense fallback={
        <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-4">
          ...
          <p className="text-muted-foreground font-medium animate-pulse">Loading secure portal...</p>
        </div>
      }>
        <CompanyPortalContent params={params} />
      </Suspense>
    </div>
  );
}
